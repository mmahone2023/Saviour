...
export default function SkyFortressReflectionPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-950 text-white px-4 py-10">
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="text-center space-y-2">
          <p className="text-sm uppercase tracking-[0.2em] text-indigo-300">Sky Fortress</p>
        ...
        <Card className="border-white/10 bg-white/5 backdrop-blur-md p-6 md:p-8 shadow-2xl">
          <p className="text-xl md:text-2xl leading-relaxed text-indigo-50 font-medium mb-8">
            {REFLECTION_PROMPT}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-2">
                <label htmlFor="reflection-phone" className="block text-sm font-semibold text-indigo-200">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-white/20 bg-black/30 px-4 py-3 text-white placeholder:text-white/40 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 disabled:opacity-50"
                />
              </div>
              <div className="space-y-2">
                <label htmlFor="reflection-email" className="block text-sm font-semibold text-indigo-200">
            ...
            <div className="space-y-2">
              <label htmlFor="reflection-message" className="block text-sm font-semibold text-indigo-200">
                Your message
              </label>
              <textarea
                ...
                disabled={status === 'submitting'}
                className="w-full resize-y rounded-lg border border-white/20 bg-black/30 px-4 py-3 text-white placeholder:text-white/40 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 disabled:opacity-50"
              />
            ...
            <p className="text-xs text-white/50">
              ...
              (<code className="text-indigo-200">MONGODB_URI</code>) to store reflections, plus{' '}
              <span className="text-indigo-300">Resend</span> / <span className="text-indigo-300">Twilio</span> for
              direct delivery — see <code className="text-indigo-200">env.example</code>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <button
                type="submit"
                disabled={status === 'submitting'}
                className="flex-1 rounded-lg bg-gradient-to-r from-indigo-500 to-violet-600 px-6 py-3 font-semibold text-white shadow-lg hover:from-indigo-400 hover:to-violet-500 transition disabled:opacity-50 disabled:pointer-events-none"
              >
